...
const DEFAULTS = {
  ...
  // HWiNFO Gadget registry (Windows). Sensor values via ValueRawN in HKCU/HKLM VSB key.
  hwinfo: {
    cpuTempIndex: null,
    ...
    hive: 'auto',   // 'HKCU' | 'HKLM' | 'auto'
  },
  // Optional nvidia-smi fallback when HWiNFO values are unavailable.
  nvidiaSmi: {
    enabled: true,
  },
};
